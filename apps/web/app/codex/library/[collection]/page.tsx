...
export default async function StoryLibraryPage({ params, searchParams }: { params: Promise<{ collection: string }>; searchParams: Promise<{ q?: string }> }) {
  ...
  return <StoryEntityDirectory collectionSlug={collection} search={filters.q?.trim() || undefined} />;
}
