...
const authErrors: Record<string, { title: string; detail: string }> = {
  AccessDenied: {
    ...
    detail: "Ask a Habitat member with invitation access for their current weekly code or an invitation to the exact email attached to your Discord account.",
  },
  ...
  return (
    <section className="auth-shell">
      <div className="auth-panel">
        ...
        <p>God&apos;s Country is private. A trusted member sends the invitation; Discord proves it is really you.</p>
