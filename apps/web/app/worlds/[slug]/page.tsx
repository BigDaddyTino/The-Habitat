...
export default async function WorldDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const [metrics, recentEvents, trackedRoster, presentPlayers, achievementCount, dispatches] = await Promise.all([
