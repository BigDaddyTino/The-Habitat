...
const characterMeta = (input: {
  ...
  storyRole: string; involvement: Array<{ arc: string; how: string }>; model: string; questions?: string[];
}) => ({
...
Quill leads survivor extraction and teaches that a route is a recent agreement with the environment, not owned ground. Her Warden affiliation gives her field doctrine, not universal authority. [[the-route-that-moves]] and [[the-bellwether]] test whether hunters can protect people without destroying the ecological signals that keep them alive.`,
    meta: characterMeta({ fullName: "Mara Quill", pronouns: "she/her", age: "mid thirties", appearance: "Weathered tracker in low-glare layers, carrying scent flags, mechanical range tools, and a field ledger of repeated animal signs.", voice: "Grounded, economical, and openly contemptuous of boss-hunt bravado.", factions: [{ faction: "wardens-monster-hunter-guild", role: "tracker and extraction specialist", standing: "respected regional field operative" }], home: "cairnwood-camp", known: "Active Warden tracker.", actual: "Her Aberrant observations are reliable but cannot explain every mechanism.", storyRole: "Field knowledge, ethical hunting, and moving-route expertise.", involvement: [{ arc: "the-bellwether", how: "Determines whether intervention, redirection, or observation is justified." }, { arc: "root-of-the-bargain", how: "Guides the route that moves." }], model: "Regional Warden tracker; non-companion." }),
  },
  {
