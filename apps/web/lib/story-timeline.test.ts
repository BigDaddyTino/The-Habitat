...
test("every codex surface a write can change is revalidated", () => {
  ...
  for (const page of ["/codex", "/codex/stories", "/codex/stories/canon", "/codex/stories/campaign", "/codex/bible", "/codex/timeline", "/codex/threads", "/codex/ideas", "/codex/promises", "/codex/review"]) {
