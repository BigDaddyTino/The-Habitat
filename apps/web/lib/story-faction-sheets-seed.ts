...
export const factionSheetSeeds = [
  {
    ...
    meta: {
      scope: "Corporate magical-extraction empire", parent: null, power: null, seat: null, leaders: [],
      relations: [
  ...
  },
  {
    ...
    meta: {
      scope: "Supernatural court of demon nobility", parent: null, power: null, seat: null, leaders: [],
  ...
  },
  {
    ...
    meta: {
      scope: "Subterranean supernatural intelligence", parent: null, power: null, seat: null, leaders: [],
  ...
  },
  {
    ...
    meta: {
      scope: "Religious power devoted to freely gifted magic", parent: null, power: null, seat: null, leaders: [],
      relations: [
  ...
  },
  {
    ...
    meta: {
      scope: "Hidden survival network for people born with magic", parent: null, power: null, seat: null, leaders: [],
      relations: [
  ...
  },
  {
    slug: "crimson-choir",
    meta: {
      scope: "Independent blood-magic cabal", parent: null, power: null, seat: null, leaders: [],
  ...
  },
  {
    ...
    meta: {
      scope: "Ruling bloc of the floating metropolis", parent: null, power: null, seat: null, leaders: [],
  ...
  },
  {
    ...
    meta: {
      scope: "State military and security apparatus", parent: null, power: null, seat: null, leaders: [],
  ...
  },
  {
    slug: "the-old-hunger",
    meta: {
      scope: "Ancient supernatural appetite with mortal orbiters", parent: null, power: null, seat: null, leaders: [],
  ...
  },
  {
    ...
    meta: {
      scope: "Necromantic order and corpse-economy civilization", parent: null, power: null, seat: null, leaders: [],
      relations: [
  ...
  },
  {
    ...
    meta: {
      scope: "Supernatural diplomatic mission", parent: null, power: null, seat: null, leaders: [], relations: [],
  ...
  },
  {
    ...
    meta: {
      scope: "Criminal maritime cartel and artifact-trade power", parent: null, power: null, seat: null, leaders: [],
      relations: [
  ...
  },
  {
    ...
    meta: {
      scope: "Commercial and maritime trade bloc", parent: null, power: null, seat: null, leaders: [],
      relations: [
