...
- [ ] Higher-resolution deep-zoom tiles, child region/city scenes, an Unplaced authoring tray, polygon editing, political/route overlays, and explicit Unreal level calibration remain subsequent phases
