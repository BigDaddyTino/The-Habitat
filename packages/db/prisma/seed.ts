...
const records = [
  ...
  // Lifetime eliminations deliberately carry no gameKey: KILLS_RECORDED is projected from hosted
  // PLAYER_KILLED events and from Club Game match participants alike, so one sum covers every
  // supported world instead of a single title's scoreboard.
  { slug: "most-verified-eliminations", title: "Most Verified Eliminations", description: "The highest verified lifetime elimination count across every supported Habitat world.", hall: "LEGENDS", category: "Combat", valueLabel: "verified eliminations", ruleType: "ACTIVITY_VALUE_SUM", ruleConfig: { version: 1, activityType: "KILLS_RECORDED", minimumConfidence: 90 }, comparison: "MAX", minimumSampleSize: 1 },
  ...
  // Deaths are counted from the projected DEATHS_RECORDED activity rather than the raw
  // PLAYER_DIED event: the activity projector is the only path that evaluates records for
  // a death, and it carries a per-row death count for sources that report matches in bulk.
  { slug: "most-verified-deaths", title: "Most Verified Deaths", description: "The most verified deaths across supported Habitat worlds. Respawning is apparently a long-term strategy.", hall: "SHAME", category: "Occupational Hazards", valueLabel: "verified deaths", ruleType: "ACTIVITY_VALUE_SUM", ruleConfig: { version: 1, activityType: "DEATHS_RECORDED", minimumConfidence: 90 }, comparison: "MAX", minimumSampleSize: 1 },
  { slug: "most-rivals-losses", title: "Most Heroic Defeats", description: "The most verified Marvel Rivals losses. Every comeback story needs an aggressively researched first act.", hall: "SHAME", gameKey: "MARVEL_RIVALS", category: "Character Building", valueLabel: "heroic defeats", ruleType: "ACTIVITY_COUNT", ruleConfig: { version: 1, activityType: "MATCH_LOST", minimumConfidence: 90 }, comparison: "MAX", minimumSampleSize: 1, enabled: crossGameConsumersEnabled },
  { slug: "most-rivals-svps", title: "Most Consolation Crowns", description: "The most verified SVP awards: officially the best person present for an outcome nobody ordered.", hall: "SHAME", gameKey: "MARVEL_RIVALS", category: "Almost Had It", valueLabel: "SVP awards", ruleType: "ACTIVITY_COUNT", ruleConfig: { version: 1, activityType: "SVP_EARNED", minimumConfidence: 90 }, comparison: "MAX", minimumSampleSize: 1, enabled: crossGameConsumersEnabled },
  // Distinct-game count over the same projected death activity as most-verified-deaths, so breadth
  // of failure is measured from the identical trusted evidence as depth of failure.
  { slug: "most-worlds-died-in", title: "Most Worlds Died In", description: "Died in the most distinct Habitat worlds. A genuinely portable talent.", hall: "SHAME", category: "Widespread Failure", valueLabel: "worlds died in", ruleType: "ACTIVITY_DISTINCT_GAME_COUNT", ruleConfig: { version: 1, activityType: "DEATHS_RECORDED", minimumConfidence: 90 }, comparison: "MAX", minimumSampleSize: 1 },
  { slug: "most-rivals-assists", title: "Most Assists, Least Credit", description: "The most verified assists. All of the setup work, none of the kill cam.", hall: "SHAME", gameKey: "MARVEL_RIVALS", category: "Supporting Role", valueLabel: "assists", ruleType: "ACTIVITY_VALUE_SUM", ruleConfig: { version: 1, activityType: "ASSISTS_RECORDED", minimumConfidence: 90 }, comparison: "MAX", minimumSampleSize: 1, enabled: crossGameConsumersEnabled },
] as const;
