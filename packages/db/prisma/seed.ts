...
const records = [
  ...
  { slug: "most-verified-deaths", title: "Most Verified Deaths", description: "The most verified deaths across supported Habitat worlds. Respawning is apparently a long-term strategy.", hall: "SHAME", category: "Occupational Hazards", valueLabel: "verified deaths", ruleType: "PLAYER_EVENT_COUNT", ruleConfig: { eventType: "PLAYER_DIED" } },
